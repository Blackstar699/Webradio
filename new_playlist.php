...
function display(){
    ...
    for($i=2; $i<$nbrCases; $i++){
        ...
        echo "<tr class=\"display__table__line\" id='".$scan[$i]."'>
            <td class='display__table__button'><input type=\"checkbox\" class='add' name=\"check".$j."\"></td>
...
<html>
<head>
    <title>Webradio - New Playlist</title>
    <meta charset="utf-8">
...
<section>
    <form action="index.php" method="post">
        <div class="title_bar">
            <h1 class="left">Cr&eacute;er une nouvelle playlist</h1>
            <input type="text" id="title" class="left input_txt" name="title" maxlength="20" minlength="1" size="20" placeholder="Nom de la playlist" value="">
            <input class="left" type="submit" value="Cr&eacute;er la playlist">
        </div>
        <div class="display">
            <table class="left">
                <tr>
